          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="p-4 rounded-2xl bg-white/60 border border-slate-200">
                ...
                <span className="text-2xl font-extrabold text-white font-mono">{totalDials}</span>
            ...
            >
              <div className="flex items-center gap-4 text-center sm:text-left">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Import Lead List (CSV / Excel)</h4>
              ...
              <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                <div className="relative flex-1 sm:w-48">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                  />
                </div>
                ...
                <select
                  ...
                  className="px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-white focus:outline-none focus:border-cyan-500"
                >
        ...
        {activeTab === 'settings' && (
          <div className="max-w-3xl rounded-3xl bg-white/80 border border-slate-200 p-6 sm:p-8 space-y-6">
            <div className="space-y-1">
              <h3 className="text-lg font-bold text-white">Fleet Telephony & Calling Window Rules</h3>
              <p className="text-xs text-slate-500">
            ...
            <form onSubmit={handleSaveSettings} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-white focus:outline-none focus:border-cyan-500"
                  />
                </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-bold text-white block">Auto Follow-Up Pipeline</span>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-white font-mono focus:outline-none focus:border-cyan-500"
                />
              </div>
          ...
          <div className="w-full max-w-3xl rounded-3xl bg-white border border-slate-200 shadow-2xl shadow-cyan-100/60 p-6 sm:p-8 relative max-h-[90vh] overflow-y-auto space-y-6">
            ...
            <div className="flex items-start justify-between pr-10">
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-extrabold text-white">{selectedLead.name}</h2>
                <p className="text-xs text-slate-500">
